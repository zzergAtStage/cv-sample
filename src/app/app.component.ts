...
import { ScrollToTopComponent } from './pages/navigation/scroll-to-top/scroll-to-top.component';

@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, CvQueriedComponent, CvStaticComponent, RouterModule, MatrixCodeComponent, LanguageSelectorComponent, ScrollToTopComponent],
